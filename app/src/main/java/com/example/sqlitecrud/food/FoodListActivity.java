package com.example.sqlitecrud.food;
...
public class FoodListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = FoodActivity.sqLiteHelper.getData("SELECT * FROM FOOD");
        list.clear();
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            // update
                            Cursor c = FoodActivity.sqLiteHelper.getData("SELECT id FROM FOOD");
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        dialog.setContentView(R.layout.activity_update_delete_layout);
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    FoodActivity.sqLiteHelper.updateData(
    ...
    private void showDialogDelete(final int idFood){
        ...
        dialogDelete.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    FoodActivity.sqLiteHelper.deleteData(idFood);

...
import com.example.sqlitecrud.model.Distance;
import com.example.sqlitecrud.model.Duration;
import com.example.sqlitecrud.model.LegsItem;
...
public class OjekActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private static final String TAG = OjekActivity.class.getSimpleName();

    private String API_KEY = "AIzaSyBxWeydTCAD08BSrAlXzDPQZD7Yyn_s2lw";
    ...
    private void actionRoute(LatLng placeLatLng, int requestCode) {
        ...
        routeRequest.enqueue(new Callback<ResponseRoute>() {
            ...
            public void onResponse(Call<ResponseRoute> call, Response<ResponseRoute> response) {
                Log.d(TAG, "onResponse: get API success :" );
            ...
            public void onFailure(Call<ResponseRoute> call, Throwable t) {
                t.printStackTrace();
                Log.e(TAG, "onFailure: error data ojek ");
            }
        });
    }
}